...
const StockOutputs = () => {
  ...
  const [listStockOutputs, setStockOutputs] = useState<any>([]);
  ...
  const removeOutput = (id: number) => {
    const newArray = listStockOutputs.filter((item: IProdProps) => item.id !== id);
        ...
        <Box w="100%">
          ...
          <Box overflowY="auto" height="80vh">
            <Table mt="6">
              ...
              <Tbody>
                {listStockOutputs.map((item: IItensProps, i: any) => (
                  <Tr key={i}>
