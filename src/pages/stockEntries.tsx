...
const StockEntries = () => {
  ...
  const [listStockEntries, setStockEntries] = useState<any>([]);
  ...
  const removeEntries = (id: number) => {
    const newArray = listStockEntries.filter((item: IProdProps) => item.id !== id);
  ...
  const getProductById = (id: number) => {
    return listProducts.filter((item: IProdProps) => item.id === id)[0]?.name;
  };
        ...
        <Box w="100%">
          <SimpleGrid minChildWidth={240} h="fit-content" spacing="6">
            ...
            >
              ...
              {listProducts &&
                ...
                listProducts.map((item: IProdProps, i: any) => (
          ...
          <Box overflowY="auto" height="80vh">
            <Table mt="6">
              ...
              <Tbody>
                {listStockEntries.map((item: IItensProps, i: any) => (
                  <Tr key={i}>
